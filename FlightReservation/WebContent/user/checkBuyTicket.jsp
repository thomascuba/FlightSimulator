		...
		try {
			...
			if(reservationNo.compareTo("new") != 0) {
				...
				if(!result.next()) {
					...
					if(!result2.next()) {
						...
						if(!aircraftCapacity.next()) {
							...
							out.println("Ticket successfully added to new reservation! Your new ticket number is " + newTicketNo +". <a href='checkUserLoginDetails.jsp'>Home</a>");
						}
						else {
							String capacity = aircraftCapacity.getString("capacity");
							if(Integer.parseInt(capacity) < newQueuePos) {
								out.println("Ticket successfully added to reservation number " + i + ", but the flight is full. Your queue position is " + (newQueuePos - Integer.parseInt(capacity)) + ". Your new ticket number is " + newTicketNo +". <a href='checkUserLoginDetails.jsp'>Home</a>");
							}
							else {
								out.println("Ticket successfully added to reservation number " + i + ". Your new ticket number is " + newTicketNo +". <a href='checkUserLoginDetails.jsp'>Home</a>");
							}
						}			
				...
				if(!result2.next()) {
					...
					if(!aircraftCapacity.next()) {
						System.out.println("Error with queues.");
						out.println("Ticket successfully added to new reservation! Your new reservation number is " + newReservationNo + ", and your new ticket number is " + newTicketNo +". <a href='checkUserLoginDetails.jsp'>Home</a>");
					}
					else {
						String capacity = aircraftCapacity.getString("capacity");
						if(Integer.parseInt(capacity) < newQueuePos) {
							out.println("Ticket successfully added to new reservation, but the flight is full. Your queue position is " + (newQueuePos - Integer.parseInt(capacity)) + ". Your new reservation number is " + newReservationNo + ", and your new ticket number is " + newTicketNo +". <a href='checkUserLoginDetails.jsp'>Home</a>");
						}
						else {
							out.println("Ticket successfully added to new reservation! Your new reservation number is " + newReservationNo + ", and your new ticket number is " + newTicketNo +". <a href='checkUserLoginDetails.jsp'>Home</a>");
						}
